...
import Item from "../../../components/molecules/items/item"
...
import { readPrice, readProductField, readProductFields } from '../../../utils/readers'
...
export default function Eat({ item }) {
  ...
  const edit = {
    ...
    layout: [
      ...
      [
        ...
        field.text("package", i => i.product.size ? `${i.product.size} g` : 'N/A', false),
      ],
      separator,
      legend.per100g,
      field.eat("kcal"),
  ...
  return (
    <Item
      ...
      showSeparator
      nutrientsToShow={['kcal', 'protein', 'carb', 'sugar', 'fat', 'saturated', 'salt']}
      item={item}
